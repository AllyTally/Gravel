...
t.version = "1.2"  -- The current version of this plugin, can be anything you want
t.minimumved = "1.7.1"  -- The minimum version of Ved this plugin is designed to work with. If unsure, just use the latest version.
t.description = [[
